...
static void print_dump(unsigned short data_len, void *data)
{
	if(!data)
		return;

	msg("");
	msg("  \tlen=%d\t%s", data_len, (char *)data);
...
{
	struct utsname u;
	char *vnet_models[] = { "SMDK4410", "SMDK4212", "SLP_PQ", "SLP_PQ_LTE", "SLP_NAPLES", "REDWOOD", "TRATS", NULL };
	int i = 0;
